...
class _ProfilePageState extends State<ProfilePage> {
  ...
  String _profileImageUrl = 'https://via.placeholder.com/120';
              ...
              _buildSectionCard(
                ...
                children: [
                  ...
                  _buildTextField(
                    ...
                    validator: (val) =>
                        val != null && val.length >= 10 ? null : 'Enter valid phone number',
                  ),
                  SizedBox(height: 16),
                  _buildTextField(
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text("Profile image tap detected")),
                  );
                },
                child: Container(
                  width: 36,
